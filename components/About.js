...
const Profile = () => {
  ...
  const aboutWidth = useTransform(scrollYProgress, [0, 0.5], ["0vw", "100vw"]);
  const showText = useTransform(scrollYProgress, [0, 0.5], [0, 1]);
  const textScale = useTransform(scrollYProgress, [0, 0.5], [0, 1]);
